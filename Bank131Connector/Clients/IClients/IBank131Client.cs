...
public interface IBank131Client {
    public Task<(bool isValid, PaymentSessionResponse? paymentSessionResponse)> SendPaymentSessionAsync(PaymentSessionClientRequest paymentSessionClientRequest);
